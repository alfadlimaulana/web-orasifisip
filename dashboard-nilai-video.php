...
$students = query("SELECT * FROM penugasan2 ORDER BY kelompok");
$jumlah_baris = get_jumlah_baris("penugasan2");

// tombol cari ditekan
if(isset($_POST["cari"])){
  $students = cari_tugas("penugasan2", $_POST["kata_kunci"]);
}

if(isset($_POST["submit_nilai"])){
  //cek berhasil atau tidak
  if(input_nilai("penugasan2", $_POST) > 0){
    echo "<script>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
      <div class="container-fluid">
        <a class="back-btn position-absolute" href="dashboard-penugasan.php"><i class="far fa-arrow-alt-circle-left"></i></a>
        <a class="navbar-brand position-absolute top-50 start-50 translate-middle" href="dashboard.php"> <img src="img/Logo.svg" alt="logo" width="auto" height="40" class="d-inline-block align-text-top" style="box-sizing: border-box" /></a>
          ...
          <table class="table align-middle">
            ...
            <?php  foreach($students as $student): ?>
              ...
              <tr>
                ...
                <td>
                  <a href="<?= $student["nama_file"]; ?>" target="_blank"><?= $student["nama_file"];?></a>
                </td>
